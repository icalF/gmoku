        ...
        protected void paintComponent(Graphics g) {
            ...
            for (int row = 0; row < rowCount; row++) {
                    for (int col = 0; col < columnCount; col++) {
                       ...
                       Rectangle cell;
                       switch(Klien.board.getBoardIJ(row, col)){
                         case 1 : cell = cells.get(index);
                                  g2d.setColor(Color.BLUE);
                                  g2d.fill(cell);
                                  break;
                         case 2 : cell = cells.get(index);
                                  g2d.setColor(Color.RED);
                                  g2d.fill(cell);
                                  break;
                         case 3 : cell = cells.get(index);
                                  g2d.setColor(Color.GREEN);
                                  g2d.fill(cell);
                                  break;
                         case 4 : cell = cells.get(index);
                                  g2d.setColor(Color.YELLOW);
                                  g2d.fill(cell);
                                  break;
                         case 5 : cell = cells.get(index);
                                  g2d.setColor(Color.MAGENTA);
                                  g2d.fill(cell);
                                  break;
                         case 6 : cell = cells.get(index);
                                  g2d.setColor(Color.orange);
                                  g2d.fill(cell);
                                  break;
                         case 7 : cell = cells.get(index);
